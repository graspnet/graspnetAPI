...
def worker(i, sample_nums, grasp_amount, good_grasp):
    ...
    yaml_config = YamlConfig(home_dir + "/workspace/git/grasp-pointnet/dex-net/test/config.yaml")
    gripper_name = 'robotiq_85'
    #gripper = RobotGripper.load(gripper_name, home_dir + "/code/grasp-pointnet/dex-net/data/grippers")
    gripper = RobotGripper.load(gripper_name, home_dir + "/workspace/git/grasp-pointnet/dex-net/data/grippers")
...
if __name__ == '__main__':
    ...
    file_dir = '/media/chenxi/DATA/YCB/ycb'
